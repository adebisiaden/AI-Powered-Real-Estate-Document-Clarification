...
variable "experiment_tracking_mlflow_image" {
  ...
  description = "Parameter use_postgres"
  type        = string
  default     = ""
}
...
variable "model_serving_fastapi_image" {
  description = "Custom image for model_serving_fastapi"
  type        = string
  default     = ""
}
...
variable "model_monitoring_grafana_image" {
  description = "Custom image for model_monitoring_grafana"
  type        = string
  default     = ""
}
...
variable "experiment_tracking_mlflow_service_name" {
  description = "Service name for experiment_tracking_mlflow"
  type        = string
  default     = ""
}
...
variable "model_serving_fastapi_service_name" {
  description = "Service name for model_serving_fastapi"
  type        = string
  default     = ""
}
    
    variable "enable_model_serving_fastapi" {
      description = "Enable/disable model_serving_fastapi module"
      type        = bool
      default     = true
    }
...
variable "model_monitoring_grafana_service_name" {
  description = "Service name for model_monitoring_grafana"
  type        = string
  default     = ""
}
    
    variable "enable_model_monitoring_grafana" {
      description = "Enable/disable model_monitoring_grafana module"
      type        = bool
      default     = true
    }
    ...
    variable "enable_cloud_sql_postgres_cloud_sql_postgres" {
      description = "Enable/disable cloud_sql_postgres_cloud_sql_postgres module"
      type        = bool
      default     = true
    }
...
# Teardown-specific variables
variable "terraform_state_bucket" {
  description = "GCS bucket for storing Terraform state (optional, for teardown)"
  type        = string
  default     = ""
}

variable "terraform_files_bucket" {
  description = "GCS bucket for storing Terraform files (optional, for teardown)"
  type        = string
  default     = ""
}
